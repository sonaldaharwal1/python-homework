...
discount_amount = original_price * discounted_percentage/100
...
fahrenheit_temperature = (temperature_Celsius *9/5) +32
...
chocolate_chips = 17
cookies = 5
number_of_chocolate_chips_in_each_cookie= chocolate_chips / cookies
print(round (number_of_chocolate_chips_in_each_cookie))
number_of_chocolate_chips_in_each_cookie = 3
total_chocolate_chips_used = number_of_chocolate_chips_in_each_cookie * cookies
remaining_chocolate_chips = chocolate_chips -total_chocolate_chips_used
print(remaining_chocolate_chips)
